...
{
    internal class ReportingServiceExecutionInspector : IClientMessageInspector
    {
        ...
        public void AfterReceiveReply(ref Message reply, object correlationState)
        {
            ...
            if (index >= 0 && _headers == null)
            {
                _headers = new MessageHeaders(MessageVersion.Soap11);
                _headers.CopyHeaderFrom(reply, reply.Headers.FindHeader("ExecutionHeader", "http://schemas.microsoft.com/sqlserver/2005/06/30/reporting/reportingservices"));
            }
        }
        ...
        {
            if (_headers != null)
                request.Headers.CopyHeadersFrom(_headers);
